 ...
 * RiPPository API
 *
 * The RiPPository API allows retrieval and filtering of records by chemical or experimental parameters, similarity search on peak lists, and access to individual record details, metadata, service status, and available filter options.
 *
 * API version: 3.0
 */
...
// GetRecord - Get a RiPPository record.
...
// GetSimpleRecord - Get a RiPPository record with reduced information level (accession, title, peaks, smiles).
